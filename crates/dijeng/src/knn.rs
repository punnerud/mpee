...
//! great-circle). The algorithm is **plain Dijeng with early termination**
...
//!
//! Memory: per worker thread holds `2 × n × 4 B` Dijeng state arrays;
    ...
    customers
        ...
        .map_init(
            ...
            |scratch, (src_idx, &src)| {
                ...
                // result is already in ascending duration order (Dijeng
